...
import com.we3j.demo.etherscan_api.request.UrlInterceptor;
import okhttp3.*;
...
public class OKHttpUtil {
    ...
    private static String domain = Endpoint.MAIN_NET;
            ...
            synchronized (OKHttpUtil.class) {
                if (okHttpClient == null) {
                    ...
                    okHttpClient = new OkHttpClient.Builder()
                            .addInterceptor(new UrlInterceptor(domain))
