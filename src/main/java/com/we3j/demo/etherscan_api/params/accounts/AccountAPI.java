...
public interface AccountAPI {
     ...
     */
    String getListNormalTransactionByAddress(String api, int records, String address);

    /**
     * @param records maximum of 10000 records only
     */
    String getListInternalTransactionByAddress(String api, int records, String address);


    String getListInternalTransactionByHash(String api, String transHash);

    String getListInternalTransactionByBlockRange(String api, long startBlock, long endBlock);

    String getContractTransactionByAddress(String api, String contractAddress, String walletAddress);

    String getNFTTransactionByAddress(String api, String contractAddress, String walletAddress);
